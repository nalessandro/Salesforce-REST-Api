...
class Client
{
     ...
     */
    public function __construct(String $login_url, String $username, String $password, String $client_id, String $client_secret)
    {
        $config = new ClientConfig($login_url, $username, $password, $client_id, $client_secret);
